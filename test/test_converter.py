...
from paper_translator.converter import PDFConverterEx, TranslateConverter
...
class TestTranslateConverter(unittest.TestCase):
    ...
    def test_translator_initialization(self):
        ...
        self.assertEqual(self.converter.translator.lang_out, "ko")

    @patch("paper_translator.converter.TranslateConverter.receive_layout")
